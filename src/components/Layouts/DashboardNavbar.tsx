...
import { AppBar, Box, IconButton, styled, Theme, Toolbar, useMediaQuery } from "@mui/material";
    ...
    <DashboardNavbarRoot position="sticky">
      <StyledToolBar>
        ...
        {settings.direction === "ltr" ? (
          <StyledIconButton disableRipple onClick={() => handleChangeDirection("rtl")}>
            <RtlIcon sx={{ color: "text.disabled" }} />
          </StyledIconButton>
        ) : (
          <StyledIconButton disableRipple onClick={() => handleChangeDirection("ltr")}>
            <LTR sx={{ color: "text.disabled" }} />
          </StyledIconButton>
        )}

        {settings.theme === "light" ? (
          <StyledIconButton disableRipple onClick={() => handleChangeTheme(THEMES.DARK)}>
            <ThemeIcon />
          </StyledIconButton>
        ) : (
          <StyledIconButton disableRipple onClick={() => handleChangeTheme(THEMES.LIGHT)}>
            <Brightness4 />
          </StyledIconButton>
        )}
