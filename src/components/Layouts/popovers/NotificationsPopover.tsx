...
function ListItem({ msg }: ListItemProps) {
  ...
  const colorbg = theme.palette.mode === "light" ? "primary.100" : "divider";
  const borderColor =
    theme.palette.mode === "light" ? "primary.200" : "divider";
  ...
  return (
    <FlexBox
      ...
      sx={{
        borderBottom: 1,
        cursor: "pointer",
        borderColor: msg.type === "new_message" ? borderColor : "divider",
