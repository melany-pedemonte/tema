...
const MainContainer = styled(Box)(({ theme }) => ({
  ...
  margin: "auto",
  padding: "5rem 0",
  [theme.breakpoints.down("sm")]: { padding: "3rem 1rem" },
}));

const StyledButton = styled(Button)(({ theme }) => ({
  marginLeft: 16,
  [theme.breakpoints.down(410)]: { marginLeft: 0, marginTop: 16 },
}));
...
export const Title = styled(H1)(({ theme }) => ({
  ...
  fontWeight: 800,
  lineHeight: 1.3,
  [theme.breakpoints.down(450)]: { fontSize: 27, lineHeight: 1.1 },
}));
  ...
  return (
    <MainContainer data-aos="fade-up">
      <Grid container spacing={4} alignItems="center">
        ...
        <Grid item md={6} xs={12}>
          {lightTheme ? (
            <img src="/static/landing-page/screens.png" width="100%" alt="" />
          ) : (
            <img
              src="/static/landing-page/screens-dark.png"
              width="100%"
              alt=""
            />
          )}
