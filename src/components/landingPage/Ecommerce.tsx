...
const StyledButton = styled(Button)(({ theme }) => ({
  marginRight: 16,
  [theme.breakpoints.down(410)]: { marginRight: 0, marginTop: 16 },
}));
    ...
    <MainContainer data-aos="fade-up">
      <Grid container spacing={4} alignItems="center">
        <Grid item md={6} xs={12}>
          {lightTheme ? (
            <img src="/static/landing-page/ecommerce.png" width="100%" alt="" />
          ) : (
            <img
              src="/static/landing-page/ecommerce-dark.png"
              width="100%"
              alt=""
            />
          )}
