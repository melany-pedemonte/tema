...
const StyledContainer = styled(Container)(({ theme }) => ({
  marginTop: 64,
  paddingTop: 80,
  [theme.breakpoints.down("sm")]: { paddingTop: 60 },
}));
...
const ContentWrapper = styled(Box)(({ theme }) => ({
  ...
  margin: "auto",
  textAlign: "center",
  [theme.breakpoints.down("sm")]: { maxWidth: 380 },
}));
    ...
    <Wrapper>
      ...
      <StyledContainer>
        ...
        <Box textAlign="center" width="auto" p={3} mt={10}>
          {lightTheme ? (
            <img
              src="/static/landing-page/dashboards.png"
              width="100%"
              alt="Dashboards"
            />
          ) : (
            <img
              src="/static/landing-page/dashboards-dark.png"
              width="100%"
              alt="Dashboards"
            />
          )}
