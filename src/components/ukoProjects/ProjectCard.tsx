...
interface ProjectCardProps {
  handleProjectMoreOpen: (event: MouseEvent<HTMLButtonElement>) => void;
}

const ProjectCard: FC<ProjectCardProps> = ({ handleProjectMoreOpen }) => {
  return (
    <Card sx={{ padding: "1rem 1.5rem" }}>
      ...
      <FlexBox alignItems="center" marginTop={1}>
        <Flag sx={{ color: "text.disabled", marginRight: 1 }} />
      ...
      <FlexBox alignItems="center" justifyContent="space-between" pt={3}>
        ...
        <AddIconButton onClick={(e: any) => console.log(e.target.value)} />
      </FlexBox>
    </Card>
  );
};
