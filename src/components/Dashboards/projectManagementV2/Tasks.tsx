...
// styled component
const ModalWrapper = styled(Card)(({ theme }) => ({
  width: 400,
  top: "50%",
  left: "50%",
  padding: 20,
          ...
          {tasks.map((task) => (
            <FormControlLabel
              ...
              sx={{
                ...
                "& .MuiCheckbox-root": { padding: 0, paddingRight: 1.2 },
          ...
          <Modal open={openModal} onClose={() => setOpenModal(false)}>
            <ModalWrapper>
              ...
              <LightTextField
                ...
                sx={{ "& textarea": { padding: "0 !important" }, boxShadow: 2 }}
              />
              <FlexBox
                alignItems="center"
              ...
              >
                <FlexBox alignItems="center">
                  <PersonAdd sx={{ mr: 1.5, color: "text.disabled" }} />
                  <Avatar
